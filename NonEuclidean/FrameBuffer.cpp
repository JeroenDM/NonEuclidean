...
FrameBuffer::FrameBuffer() {
  ...
  glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, GH_FBO_SIZE, GH_FBO_SIZE, 0, GL_RGB,
...
void FrameBuffer::Use() { glBindTexture(GL_TEXTURE_2D, texId); }

void FrameBuffer::Render(const Camera& cam, GLuint curFBO,
